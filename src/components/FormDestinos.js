...
class FormDestinos extends Component {
  constructor(props){
    super(props);
    this.state = {
        tipo: "",
      ...
      return (
        <React.Fragment>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField multiline id="state" name="state" label="DESTINOOOS" fullWidth />
            </Grid>
...
export default withRouter(withStyles(styles)(FormDestinos));
